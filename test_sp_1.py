...
for i in range(0, len(r)):
    os.system("rm -f LDPC_test_sp1_{}".format(i))
    os.system("{} -DR_BITS={}ULL -DDV={}ULL -DT1={}ULL -DW_DECODER={} -o LDPC_test_sp1_{}".format(s, r[i], w//2, t, 0, i))
    os.system("./LDPC_test_sp1_{} > output_sp1_{}".format(i, i))